...
| `addCommercetoolsLineItems`  | Boolean attribute. If set to **true**, integration will add lineItems to payment methods that require lineItems on `makePaymentRequest`.                                           | NO       | false                                                                                                                        |

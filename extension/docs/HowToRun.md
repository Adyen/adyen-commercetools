...
| `addCommercetoolsLineItems`  | Boolean attribute. Set on default to **false**. If set to **true**, integratiom will add lineItems to payment methods that require lineItems on `makePaymentRequest`.              | NO       | false                                                                                                                        |

...
| --------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `adyen`         | `apiBaseUrl`                 | [Checkout endpoint](https://docs.adyen.com/development-resources/live-endpoints#checkout-endpoints) of Adyen.                                                                                                                                                                                                                                                                                                    | `https://checkout-test.adyen.com/v68` (even though it is not required, you **need** to specify a URL for **live environment**)                                              | | `https://pal-test.adyen.com/pal/servlet` (even though it is not required, you **need** to specify a URL for **live environment** to use e.g. manualCapture, refund, cancel) |

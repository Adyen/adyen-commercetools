...
1. **Continue with one of the supported payment methods**
    > As a second part, after getting the list of available payment methods, shopper will select a payment method and make a payment, please follow the steps below for processing the payment with extension module:

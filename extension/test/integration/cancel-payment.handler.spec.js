...
const {
  CTP_ADYEN_INTEGRATION, CTP_INTERACTION_TYPE_CANCEL_PAYMENT, CTP_PAYMENT_CUSTOM_TYPE_KEY
...
describe('::cancel::', () => {
  ...
  it('given a payment with "authorization success transaction" ' +
    ...
    const { statusCode, body: cancelledPayment } = await ctpClient.update(ctpClient.builder.payments,
    ...
    const interfaceInteraction = cancelledPayment.interfaceInteractions
      .find(interaction => interaction.fields.type === CTP_INTERACTION_TYPE_CANCEL_PAYMENT)
